export const verificationMailHTML = (name, verifyTokenURL) => {
...
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">1. Click on the link above and complete your verification.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. Contact your classroom representative with your username for manual verification.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">3. Get access to notices and resources. </span></div>

<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">4. Request for API Key and build something cool</span></div>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="6E6E6E">
                                            ...
                                            <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">Pokharauniversity.io</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">Code Kavya</span>, <span class="Unsubscribe--senderCity">Pokhara</span>, <span class="Unsubscribe--senderState">Nepal</span> <span class="codekavya--senderZip">33700</span></p></div>
                                            <p style="font-size:12px; line-height:20px;"><a class="codekavya--codekavyalink" href="https://codekavya.com" target="_blank" style="">Codekavya</a> - <a href="https://Pokharauniversity.io" target="_blank" class="Pokharauniversity--pokharauniversityioweb" style="">Pokharauniversity.io</a></p>
...
export const passwordResetMailHTML = (name, resetURl) => {
                                    ...
                                    <tr>
                                      ...
                                      >
                                                            ...
                                                            <tr>
                                                              ...
                                                              >
                                                                <img
                                                                  ...
                                                                  src="https://cdn.discordapp.com/attachments/752859321468977162/826706994466521088/Puio4x.png"
                                                                  height="45"
                                                                />
                                                              </td>
                                                            </tr>
                                                                ...
                                                                >
                                                                  <tbody>
                                                                    <tr>
                                                                      ...
                                                                      >
                                                                        <a
                                                                          href="mailto:codekavyaofficial@gmail.com"
                                                                          style="
                                                                            background-color: #ffbe00;
                                                                            border: 1px
                                                                              solid
                                        ...
                                        >
                                          <div class="Unsubscribe--addressLine">
                                            ...
                                            >
                                              ...
                                              <span
                                                ...
                                                >Nepal</span
                                              >
                                              <span class="codekavya--senderZip"
                                                >33700</span
                                              >
                                            </p>
                                          </div>
                                          ...
                                          >
                                            <a
                                              class="codekavya--codekavyalink"
                                              href="https://codekavya.com"
                                              target="_blank"
                                              style=""
                                              >Codekavya</a
                                            >
                                            -
                                            <a
                                              href="https://Pokharauniversity.io"
                                              target="_blank"
                                              class="Pokharauniversity--pokharauniversityioweb"
                                              style=""
                                              >Pokharauniversity.io</a
                                            >
                                          </p>
                                        </div>
                                        <table
